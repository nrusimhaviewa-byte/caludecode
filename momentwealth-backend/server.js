...
async function getLiveSwingSetups() {
  ...
  return [
    ...
    { name: 'Sterling and Wilson Renewable', ticker: 'SWSOLAR', channel: 'WhatsApp (Swing Pool PRO)', source: 'Swing Pool PRO', tag: 'swingpool', entry: 485.00, sl: 455.00, target: 565.00, catalyst: '⚡ Fresh Mega Win: Bags landmark solar EPC orders worth ₹985 Cr; Targets 530 / 565', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:20 IST' },
    { name: 'Welspun Corp', ticker: 'WELCORP', channel: 'WhatsApp (Swing Pool PRO)', source: 'Swing Pool PRO', tag: 'swingpool', entry: 840.00, sl: 805.00, target: 960.00, catalyst: '⚡ Mega Catalyst: Associate East Pipes ₹2,000 Cr Saudi Aramco line-pipe supply contract follow-through; targets 900 / 960', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:30 IST' },
    { name: 'Shakti Pumps', ticker: 'SHAKTIPUMP', channel: 'WhatsApp (Swing Pool PRO)', source: 'Swing Pool PRO', tag: 'swingpool', entry: 1040.00, sl: 990.00, target: 1250.00, catalyst: '⚡ Solar EPC Delivery: Upper circuit surge following ₹236 Cr MSEDCL solar pump order execution; Tgt 1,180/1,250', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:35 IST' },
    { name: 'Redington India', ticker: 'REDINGTON', channel: 'WhatsApp (Swing Pool PRO)', source: 'Swing Pool PRO', tag: 'swingpool', entry: 390.00, sl: 370.00, target: 465.00, catalyst: '🚀 Apple iPhone 18 distribution expansion; momentum breakout above ATH ₹392; Tgt 435/465', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:40 IST' },
    { name: 'Dilip Buildcon', ticker: 'DBL', channel: 'WhatsApp (Swing Pool PRO)', source: 'Swing Pool PRO', tag: 'swingpool', entry: 515.00, sl: 490.00, target: 620.00, catalyst: '🏗️ Power Infra: Selected for 400 KV GIS Solapur/Paranda Switching Station by REC Power; Tgt 570/620', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:45 IST' },
    { name: 'Oil India', ticker: 'OIL', channel: 'WhatsApp (+91 9701168672)', source: 'WhatsApp Direct', tag: 'swingpool', entry: 680.00, sl: 645.00, target: 755.00, catalyst: '🛢️ Upstream Play: Crude consolidates; strong domestic realization & Q2 dividend yield cushion', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:15 IST' },
    { name: 'Tata Steel', ticker: 'TATASTEEL', channel: 'WhatsApp (+91 9701168672)', source: 'WhatsApp Direct', tag: 'swingpool', entry: 152.00, sl: 146.00, target: 174.00, catalyst: '🔥 CEO TV Narendran highlights global focus on Indian steel manufacturing; volume rebound', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:50 IST' },

    // 🔵 Live Telegram Community Channels (Stockpro Online, Breakout Investing, BreakoutStreak, Univest)
    { name: 'Protean eGov Technologies', ticker: 'PROTEAN', channel: 'Telegram (Stockpro Online)', source: 'Stockpro Online', tag: 'telegram', entry: 595.00, sl: 560.00, target: 710.00, catalyst: '🔒 NSE IPO Allotment Multiplier: Leads market tech infrastructure volume breakout; Targets 660 / 710', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:25 IST' },
    { name: 'Phoenix Mills', ticker: 'PHOENIXLTD', channel: 'Telegram (Breakout Investing)', source: 'Breakout Investing', tag: 'telegram', entry: 1680.00, sl: 1610.00, target: 1880.00, catalyst: '🛍️ Retail Consumption Spike: Spikes on record festive mall footfalls and urban consumption data', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:30 IST' },
    { name: 'HEG Advanced Materials', ticker: 'HEG', channel: 'Telegram (Breakout Investing)', source: 'Breakout Investing', tag: 'telegram', entry: 245.00, sl: 230.00, target: 300.00, catalyst: '🚀 Clean Tech Order Win: Subsidiary Replus Engitech secures ₹218 Cr lithium-ion battery orders; Tgt 275/300', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:40 IST' },
    { name: 'LEAP India', ticker: 'LEAPINDIA', channel: 'Telegram (Univest Research)', source: 'Univest Research', tag: 'telegram', entry: 352.00, sl: 330.00, target: 450.00, catalyst: '⚡ UBS Buy Initiation: Global brokerage initiates coverage with Buy and 25% upside target of ₹450', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:45 IST' },
    { name: 'Jash Engineering', ticker: 'JASH', channel: 'Telegram (BreakoutStreak)', source: 'BreakoutStreak', tag: 'telegram', entry: 598.00, sl: 565.00, target: 705.00, catalyst: '⚡ 8.4x Volume Spurt: Water and engineering infra equipment volume breakout past ₹592', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:50 IST' },
    { name: 'CG Power & Industrial', ticker: 'CGPOWER', channel: 'Telegram (Stockpro Online)', source: 'Stockpro Online', tag: 'telegram', entry: 915.00, sl: 880.00, target: 1040.00, catalyst: '⚡ Industrial Equipment Momentum: Surges on broad-based substation and automation capex', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:55 IST' },

    // 🟣 Instagram (StockMarket Times & TradeClues)
    { name: 'Jio Financial', ticker: 'JIOFIN', channel: 'Instagram (@StockMarketTimes)', source: 'StockMarket Times', tag: 'instagram', entry: 342.00, sl: 322.00, target: 398.00, catalyst: 'SEBI Clearance & BlackRock JV Wealth Scaling; High festive retail expansion', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:15 IST' },
    { name: 'Suzlon Energy', ticker: 'SUZLON', channel: 'Instagram (@StockMarketTimes)', source: 'StockMarket Times', tag: 'instagram', entry: 76.50, sl: 70.00, target: 94.00, catalyst: 'Record 5.4 GW Wind Turbine Order Backlog & execution velocity', date: '22 Sep 2026', recommendedAt: '22 Sep 2026, 09:15 IST' }
  ];
}
